...
@section('content-header')
    <h1>
        {{ trans('ipaperwork::companies.title.edit company') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.ipaperwork.company.index') }}">{{ trans('ipaperwork::companies.title.companies') }}</a></li>
        <li class="active">{{ trans('ipaperwork::companies.title.edit company') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.ipaperwork.company.update', $company->id], 'method' => 'put']) !!}
    <div class="row">
        ...
        <div class="col-xs-12 col-md-8">
            <div class="row">
                ...
                @include('ipaperwork::admin.companies.partials.edit-fields')
         ...
         <div class="col-xs-12 col-md-4">
            @include('ipaperwork::admin.companies.partials.edit-fields-right') 
        </div>
