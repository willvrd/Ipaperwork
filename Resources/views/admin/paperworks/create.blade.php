...
@section('content-header')
    <h1>
        {{ trans('ipaperwork::paperworks.title.create paperwork') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.ipaperwork.paperwork.index') }}">{{ trans('ipaperwork::paperworks.title.paperworks') }}</a></li>
        <li class="active">{{ trans('ipaperwork::paperworks.title.create paperwork') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.ipaperwork.paperwork.store'], 'method' => 'post']) !!}
    <div class="row">
        ...
        <div class="col-xs-12 col-md-9">
            <div class="row">
                            ...
                            <div class="tab-content">
                                ...
                                @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                                    ...
                                    <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                                        @include('ipaperwork::admin.paperworks.partials.create-fields-translatables', ['lang' => $locale])
                                    </div>
                                @endforeach
                            </div>
                        </div>
                ...
                @include('ipaperwork::admin.paperworks.partials.create-fields')
        ...
        <div class="col-xs-12 col-md-3">
            @include('ipaperwork::admin.paperworks.partials.create-fields-right') 
        </div>
