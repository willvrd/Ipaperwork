...
@section('content-header')
    <h1>
        {{ trans('ipaperwork::userpaperworks.title.create userpaperwork') }}
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('ipaperwork::userpaperworks.title.create userpaperwork') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.ipaperwork.userpaperwork.store'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('ipaperwork::admin.userpaperworks.partials.create-fields', ['lang' => $locale])
                        </div>
                    @endforeach
